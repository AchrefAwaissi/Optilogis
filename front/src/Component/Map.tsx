      ...
      <div className="mt-4">
        ...
        <div className="mt-2 grid grid-cols-3 gap-2">
          <button
            ...
            className={`inline-flex flex-col justify-center items-center py-2 px-3 border border-transparent shadow-sm text-sm font-medium rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#084440] transition-colors duration-200 ${
              routeDetails.transit ? 'bg-[#084440]' : 'bg-gray-500 hover:bg-gray-600'
            }`}
          >
            <Bus size={18} className="mb-1" />
            Transport
          </button>
          <button
            onClick={() => handleRouteSearch(google.maps.TravelMode.DRIVING)}
            className={`inline-flex flex-col justify-center items-center py-2 px-3 border border-transparent shadow-sm text-sm font-medium rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#084440] transition-colors duration-200 ${
              routeDetails.driving ? 'bg-[#084440]' : 'bg-gray-500 hover:bg-gray-600'
            }`}
          >
          ...
          <button
            ...
            className={`inline-flex flex-col justify-center items-center py-2 px-3 border border-transparent shadow-sm text-sm font-medium rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#084440] transition-colors duration-200 ${
              routeDetails.bicycling ? 'bg-[#084440]' : 'bg-gray-500 hover:bg-gray-600'
            }`}
          >
